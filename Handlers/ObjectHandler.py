...
class ObjectHandler(QGraphicsRectItem):
    def __init__(self, x, y, width, height, color, name, main_window):
        ...
        self.border_hover_color = QColor(255, 0, 0)  # Border hover color

        # Set the appearance
        self.setBrush(QBrush(self.normal_color))  # Set color for the object
        self.setPen(QPen(self.border_color, 10))  # Set the border for the object
    ...
    def hoverEnterEvent(self, event):
        ...
        self.setPen(QPen(self.border_hover_color, 10))  # Change border to hover color
    ...
    def hoverLeaveEvent(self, event):
        ...
        self.setPen(QPen(self.border_color, 10))  # Revert back to normal border color
